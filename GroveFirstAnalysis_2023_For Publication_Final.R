...
### Extended Data Fig 4a Plant health index Day 0 to 90----
fulldata <- fulldata %>%
...
## Extended Data Fig 4b Plant health index Day 0 to 180 ----
...
## Extended Data Fig 4c Plant health index Day 0 to 270 ----
...
## Extended Data Fig 6a Plant health vs Tree rating Day 90 ----
...
## Extended Data Fig 6b Plant health vs Tree rating Day 180 ----
...
## Extended Data Fig 6c Plant health vs Tree rating Day 270 ----
...
## Extended Data Fig 8a Day 90 Number of Total fruit (sorted only) vs change in plant health index ----
...
## Extended Data Fig 8a Day 180 Number of Total fruit (sorted only) vs change in plant health index ----
...
## Extended Data Fig 8a Day 270 Number of Total fruit (sorted only) vs change in plant health index ----
...
## Extended Data Fig 8b Day 0 to 90 Fruit Weight x Plant Health Index ----
...
## Extended Data Fig 8b Day 0 to 180 Fruit Weight x Plant Health Index ----
...
## Extended Data Fig 8b Day 0 to 270 Fruit Weight x Plant Health Index ----
...
## Extended Data Table 2 Pairwise t-tests for fruit drop between each treatment and M53 ----
...
## Extended Data Table 3 Pairwise t-tests for yield between treatments and M53 ----
# Welch's ANOVA (doesn't assume equal variances)
...
## Extended Data Table 4 Pairwise t-tests for fruit weight between each treatment and M53 ----
# Welch's ANOVA (doesn't assume equal variances)
...
## Extended Data Table 5 Pairwise t-tests for Brix between each Treatment and M53 ----
# Welch's ANOVA (doesn't assume equal variances)
...
## Extended Data Table 6 Pairwise t-test comparison for Solids per box between each treatment and M53 ----
# Welch's ANOVA (doesn't assume equal variances)
